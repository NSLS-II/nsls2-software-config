...
yes | LD_LIBRARY_PATH=${IDIR}/lib ./pip install wheel numpy scipy matplotlib mpi4py Cython ipython jupyter ninja meson jupyterhub sudospawner sympy PyQt5 argos ipympl
