...
wget https://flair.web.cern.ch/flair/download/flair-3.2-0.tgz
wget https://flair.web.cern.ch/flair/download/flair-geoviewer-3.2-0.tgz
tar zxf flair-3.2-0.tgz
tar zxf flair-geoviewer-3.2-0.tgz
mv flair-3.2 ../3.2-0
cd flair-geoviewer-3.2/
make -j
make install DESTDIR=/nsls2/software/ap/flair/3.2-0
cd ..
rm -rf flair-geoviewer-3.2/
