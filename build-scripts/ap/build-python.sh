...
yes | LD_LIBRARY_PATH=/nsls2/software/ap/python/$ver/lib ./pip install wheel numpy scipy matplotlib mpi4py Cython ipython jupyter ninja meson jupyterhub sudospawner
